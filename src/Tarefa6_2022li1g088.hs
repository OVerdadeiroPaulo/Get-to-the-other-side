...
desenhaMundo (PaginaPrincipal Jogar, jogo, imagens, tempo, direccao, imagens2, imagens3, imagens4) = Pictures ([fundoAnimado1] ++ [pagPrincipal])
            where fundoAnimado1 = imagefundo1 tempo imagens4
...
desenhaMundo (PaginaJogar d, jogo, imagens, tempo, direccao, imagens2, imagens3, imagens4) | d == Facil = Translate (-630) (370) $ scale 1.91 0.68 $ Pictures world28 
 ...
 where 
     ...
     desenhajogador1 = criarJogador1 (getJogador (PaginaJogar Facil, jogo, imagens, tempo, direccao, imagens2, imagens3, imagens4)) tempo imagens direccao
     tempoDeJogo1 = mostrarTempo tempo
     scoore1 = mostrarScoore tempo 
     ...
     desenhajogador2 = criarJogador2 (getJogador (PaginaJogar Media, jogo, imagens, tempo, direccao, imagens2, imagens3, imagens4)) tempo imagens2 direccao
     tempoDeJogo2 = mostrarTempo tempo
     scoore2 = mostrarScoore tempo
     ...
     desenhajogador3 = criarJogador3 (getJogador (PaginaJogar Dificil, jogo, imagens, tempo, direccao, imagens2, imagens3, imagens4)) tempo imagens3 direccao 
     tempoDeJogo3 = mostrarTempo tempo
...
>>>>>>> b3611440119bbc0ca76c419f23a496e22a1be304
@
-}
...
criarJogador1 (Jogador (x,y)) t imagens (Move Direita)  | (mod (round (t*22222)) 40) < 9 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 10 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 11 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 12 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 13 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 14 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 15 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 16 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 17 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 18 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 19 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 20 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 21 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 22 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 23 = Translate (saltaX x) (saltaY y) (imagens !! 145)
                                                        | (mod (round (t*22222)) 40) < 24 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 25 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 26 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 27 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 28 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 29 = Translate (saltaX x) (saltaY y) (imagens !! 140)
                                                        | (mod (round (t*22222)) 40) < 30 = Translate (saltaX x) (saltaY y) (imagens !! 140)
...
{-| Forma alternativa de chamar os bmps
...
{-| Algumas imagens de teste, o nenhum com a picture blank e o jogo1, o jogo inicial
